...
public class ReadFileServlet {
	...
	public Response getFile() {
		...
		String file = "Documentos/TrabalhoAndré/arquivo_dados.csv";
	...
	private static String saveFile(List<School> schools) {
		...
		try {
			...
			String input = "{\"codigo\":1,\"nome\":\"Pedro\"}";
			...
			if (conn.getResponseCode() != HttpURLConnection.HTTP_CREATED) {
				throw new RuntimeException("Erro, codigo http:  " + conn.getResponseCode());
			}
